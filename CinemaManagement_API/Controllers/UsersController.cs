...
namespace CinemaManagement_API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        UsersController(CinemaManagementDbContext cinemaManagementDbContext, IMapper mapper)
        {
        ...
        public IActionResult Create(AddUserModel user)
        {
            ...
            cinemaManagementDbContext.Users.Add(_mapper.Map<User>(user));
        ...
        public IActionResult Read()
        {
            ...
            return Ok(cinemaManagementDbContext.Users.ToList());
        }

        [HttpGet("{id}")]
        public IActionResult Get(string id)
        {
            if (cinemaManagementDbContext.Users.Find(id) == null)
            {
                return NotFound();
            }

            return Ok(cinemaManagementDbContext.Users.Find(id));
        }
